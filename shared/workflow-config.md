...
| **Zdroje pravdy** | `plan-milestone`, `review-milestone`, `implement-issue`, `verify-issue`, `write-adr`, `review-adr` | kde se ukotvují a ověřují akceptační kritéria a tvrzení ADR |
