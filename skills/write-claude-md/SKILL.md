...
when_to_use: >-
  ...
  /init, jehož výstup bývá rozvláčný. Nepoužívej pro zakládání skillů, na to
  slouží write-skill; pro agenty write-agent; ani pro zápis do trvalé paměti
  agenta, na to je train-agent.
